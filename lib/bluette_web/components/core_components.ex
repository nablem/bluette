defmodule BluetteWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BluetteWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BluetteWeb.Gettext, "errors", msg, opts)
    end
  end
