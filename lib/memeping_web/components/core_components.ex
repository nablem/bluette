defmodule MemePingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MemePingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MemePingWeb.Gettext, "errors", msg, opts)
    end
  end
